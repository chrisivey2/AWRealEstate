...
public abstract class Hilt_WireFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WireFragment_GeneratedInjector) this.generatedComponent()).injectWireFragment(UnsafeCasts.<WireFragment>unsafeCast(this));
    }
  }
