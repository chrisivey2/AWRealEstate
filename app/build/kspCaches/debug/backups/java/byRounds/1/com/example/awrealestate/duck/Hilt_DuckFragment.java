...
public abstract class Hilt_DuckFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DuckFragment_GeneratedInjector) this.generatedComponent()).injectDuckFragment(UnsafeCasts.<DuckFragment>unsafeCast(this));
    }
  }
