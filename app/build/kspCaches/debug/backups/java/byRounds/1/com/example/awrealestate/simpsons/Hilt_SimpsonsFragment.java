...
public abstract class Hilt_SimpsonsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SimpsonsFragment() {
    super();
  }

  Hilt_SimpsonsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SimpsonsFragment_GeneratedInjector) this.generatedComponent()).injectSimpsonsFragment(UnsafeCasts.<SimpsonsFragment>unsafeCast(this));
    }
  }
